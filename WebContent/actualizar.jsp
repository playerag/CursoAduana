			...
			<div class="card-panel">
				...
				<form action="control.do" method="post">
					...
					<div class="input-field">
						...
						<input	readOnly = "true" id="rut" type="text" name="rut" value="${param.rut }"> <label
							for="rut">Rut</label>
					</div>
					<div class="input-field">
					...
					<button name="boton" value="actualizar" type="submit" 	class="btn right red">Actualizar</button>
					<br></br>
				</form>
